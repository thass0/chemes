...
impl<'a> Cursor<'a> {
	...
	match self.peek() {
	    ...
	    Some(_) | None => {
		Token::new(TokenKind::Number(n1.into()), fix)
	    }
	}
    }
...
(define (fib n)
    (cond
      ...
      (else
		...
		Token { kind: LParen, at: Position { line: 2, column: 9 } },
		Token {
		    kind: Symbol("fib".to_owned()),
		    at: Position { line: 2, column: 10 }
		},
		Token {
		    kind: Symbol("n".to_owned()),
		    at: Position { line: 2, column: 14 }
		},
		Token { kind: RParen, at: Position { line: 2, column: 15 } },
		Token { kind: LParen, at: Position { line: 3, column: 5 } },
		Token {
		    kind: Symbol("cond".to_owned()),
		    at: Position { line: 3, column: 6 }
		},
		Token { kind: LParen, at: Position { line: 4, column: 7 } },
		Token { kind: LParen, at: Position { line: 4, column: 8 } },
		Token {
		...
		Token {
		    kind: Symbol("n".to_owned()),
		    at: Position { line: 4, column: 11 }
		},
		Token {
		    kind: Number(0.into()),
		    at: Position { line: 4, column: 13 }
		},
		Token { kind: RParen, at: Position { line: 4, column: 14 } },
		Token {
		    kind: Number(0.into()),
		    at: Position { line: 4, column: 16 }
		},
		Token { kind: RParen, at: Position { line: 4, column: 17 } },
		Token { kind: LParen, at: Position { line: 5, column: 7 } },
		Token { kind: LParen, at: Position { line: 5, column: 8 } },
		Token {
		    kind: Symbol("=".to_owned()),
		...
		Token {
		    kind: Symbol("n".to_owned()),
		    at: Position { line: 5, column: 11 }
		},
		Token {
		    kind: Number(1.into()),
		    at: Position { line: 5, column: 13 }
		},
		Token { kind: RParen, at: Position { line: 5, column: 14 } },
		Token {
		    kind: Number(1.into()),
		    at: Position { line: 5, column: 16 }
		},
		Token { kind: RParen, at: Position { line: 5, column: 17 } },
		Token { kind: LParen, at: Position { line: 6, column: 7 } },
		Token {
		    kind: Symbol("else".to_owned()),
		    at: Position { line: 6, column: 8 }
		},
		Token { kind: LParen, at: Position { line: 7, column: 9 } },
		Token {
		    kind: Symbol("+".to_owned()),
		    at: Position { line: 7, column: 10 }
		},
		Token { kind: LParen, at: Position { line: 7, column: 12 } },
		Token {
		    kind: Symbol("fib".to_owned()),
		    at: Position { line: 7, column: 13 }
		},
		Token { kind: LParen, at: Position { line: 7, column: 17 } },
		Token {
		    kind: Symbol("-".to_owned()),
		    at: Position { line: 7, column: 18 }
		},
		Token {
		    kind: Symbol("n".to_owned()),
		    at: Position { line: 7, column: 20 }
		},
		Token {
		    kind: Number(1.into()),
		    at: Position { line: 7, column: 22 }
		},
		Token { kind: RParen, at: Position { line: 7, column: 23 } },
		Token { kind: RParen, at: Position { line: 7, column: 24 } },
		Token { kind: LParen, at: Position { line: 8, column: 12 } },
		Token {
		    kind: Symbol("fib".to_owned()),
		    at: Position { line: 8, column: 13 }
		},
		Token { kind: LParen, at: Position { line: 8, column: 17 } },
		Token {
		    kind: Symbol("-".to_owned()),
		    at: Position { line: 8, column: 18 }
		},
		Token {
		    kind: Symbol("n".to_owned()),
		    at: Position { line: 8, column: 20 }
		},
		Token {
		    kind: Number(2.into()),
		    at: Position { line: 8, column: 22 }
		},
		Token { kind: RParen, at: Position { line: 8, column: 23 } },
		Token { kind: RParen, at: Position { line: 8, column: 24 } },
		Token { kind: RParen, at: Position { line: 8, column: 25 } },
		Token { kind: RParen, at: Position { line: 8, column: 26 } },
